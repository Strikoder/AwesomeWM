...
awful.screen.connect_for_each_screen(function(s)
    ...
    s.mytasklist = awful.widget.tasklist {
        ...
        style   = {
            bg_normal = "#000000AA", -- Fully transparent background
            bg_focus = "#00000AA",   -- Fully transparent background
            -- Other styling properties...
        },
    }

    -- Create the wibox
    s.mywibox = awful.wibar({ position = "top", screen = s, bg = "#000000AA" })
...
--- my customization
    awful.key({ modkey }, "r", function() awful.util.spawn("google-chrome") end,
        { description = "run chrome", group = "amin" }),
    awful.key({ modkey }, "w", function()
            local c = client.focus
            if c then c:kill() end
        end,
        { description = "close", group = "amin" }),
    ...
    awful.key({ modkey, "Shift" }, "s", function() awful.spawn("/home/strikoder/.config/awesome/screenshot.sh") end,
...
awful.rules.rules = {
    ...
    -- Rule for Google Chrome
    {
        rule = { class = "Google-chrome" },
        properties = { tag = "browsing" }
    },

    -- Rule for Code Editor (e.g., Visual Studio Code)
    {
        rule = { class = "Code" },
        properties = { tag = "coding" }
    },
}
-- }}}
